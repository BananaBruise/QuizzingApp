...
public class QuestionMakerActivity extends AppCompatActivity {
    ...
    public void submitQuestion(View v) {
        ...
        int diff = difficulty.getNumStars();

        // answer attributes
        boolean c1 = correct1.isChecked();
        String t1 = answerText1.getText().toString();
        boolean c2 = correct1.isChecked();
        String t2 = answerText1.getText().toString();
        boolean c3 = correct1.isChecked();
        String t3 = answerText1.getText().toString();
        boolean c4 = correct1.isChecked();
        String t4 = answerText1.getText().toString();
